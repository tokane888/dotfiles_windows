...
choco install --yes autohotkey clibor etcher Everything lhaplus manictime microsoft-windows-terminal powershell-core powertoys slack vlc vscode wireshark xmind zoom
