...
cinst --yes autohotkey bind-toolsonly choco-cleaner docker-desktop dropbox etcher Everything git go lhaplus manictime microsoft-teams microsoft-windows-terminal picotorrent powershell-core slack vim virtualbox vlc vscode WinPcap wireshark zoom
