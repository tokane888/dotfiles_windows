...
choco install --yes autohotkey bind-toolsonly choco-cleaner etcher Everything git go lhaplus manictime microsoft-windows-terminal powershell-core slack vim virtualbox vlc vscode wireshark xmind zoom
