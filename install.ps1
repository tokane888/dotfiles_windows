...
cinst --yes autohotkey bind-toolsonly docker-desktop dropbox etcher Everything git googledrive go lhaplus manictime microsoft-teams microsoft-windows-terminal picotorrent powershell-core SakuraEditor slack vim virtualbox vlc vscode winmerge wireshark zoom
