...
choco install --yes autohotkey etcher Everything lhaplus manictime microsoft-windows-terminal powershell-core powertoys slack vlc vscode wireshark xmind zoom
