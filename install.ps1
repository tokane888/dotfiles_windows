...
cinst --yes autohotkey bind-toolsonly docker-desktop dropbox Everything git googledrive go lhaplus manictime microsoft-teams microsoft-windows-terminal powershell-core SakuraEditor slack vim virtualbox vlc vscode winmerge wireshark zoom
