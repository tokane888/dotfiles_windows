...
cinst --yes autohotkey bind-toolsonly choco-cleaner dropbox etcher Everything git go lhaplus manictime microsoft-teams microsoft-windows-terminal picotorrent powershell-core slack toggl vim virtualbox vlc vscode WinPcap wireshark zoom
